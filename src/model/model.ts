...
module BP3D.Model {
  ...
  export class Model {
    ...
    /** */
    private roomLoadingCallbacks = new Core.Callbacks();

    /** */
    private roomLoadedCallbacks = new Core.Callbacks();

    /** name */
    private roomSavedCallbacks = new Core.Callbacks();

    /** success (bool), copy (bool) */
    private roomDeletedCallbacks = new Core.Callbacks();
