...
module BP3D.Model {
  ...
  export class Floorplan {
    ...
    /** */
    private new_wall_callbacks = new Core.Callbacks();

    /** */
    private new_corner_callbacks = new Core.Callbacks();

    /** */
    private redraw_callbacks = new Core.Callbacks();

    /** */
    private updated_rooms = new Core.Callbacks();

    /** */
    public roomLoadedCallbacks = new Core.Callbacks();
