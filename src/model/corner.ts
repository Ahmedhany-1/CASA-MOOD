...
module BP3D.Model {
  ...
  export class Corner {
    ...
    private moved_callbacks = new Core.Callbacks();

    /** Callbacks to be fired on removal. */
    private deleted_callbacks = new Core.Callbacks();

    /** Callbacks to be fired in case of action. */
    private action_callbacks = new Core.Callbacks();
