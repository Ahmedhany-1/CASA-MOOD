...
(function (BP3D) {
    ...
    (function (Core) {
        ...
        var Callbacks = (function () {
             ...
             */
            Callbacks.prototype.has = function (callback) {
    ...
    (function (Model) {
        ...
        var Corner = (function () {
            ...
            function Corner(floorplan, x, y, id) {
                ...
                this.moved_callbacks = new BP3D.Core.Callbacks();
                /** Callbacks to be fired on removal. */
                this.deleted_callbacks = new BP3D.Core.Callbacks();
                /** Callbacks to be fired in case of action. */
                this.action_callbacks = new BP3D.Core.Callbacks();
    ...
    (function (Model) {
        ...
        var HalfEdge = (function () {
            ...
            function HalfEdge(room, wall, front) {
                ...
                /** */
                this.redrawCallbacks = new BP3D.Core.Callbacks();
                /**
    ...
    (function (Model) {
        ...
        var Room = (function () {
            ...
            function Room(floorplan, corners) {
                ...
                /** */
                this.floorChangeCallbacks = new BP3D.Core.Callbacks();
                this.updateWalls();
    ...
    (function (Model) {
        ...
        var Floorplan = (function () {
            ...
            function Floorplan() {
                ...
                this.rooms = [];
                /** */
                this.new_wall_callbacks = new BP3D.Core.Callbacks();
                /** */
                this.new_corner_callbacks = new BP3D.Core.Callbacks();
                /** */
                this.redraw_callbacks = new BP3D.Core.Callbacks();
                /** */
                this.updated_rooms = new BP3D.Core.Callbacks();
                /** */
                this.roomLoadedCallbacks = new BP3D.Core.Callbacks();
                /**
    ...
    (function (Model) {
        ...
        var Scene = (function () {
            ...
            function Scene(model, textureDir) {
                ...
                /** */
                this.itemLoadingCallbacks = new BP3D.Core.Callbacks();
                /** Item */
                this.itemLoadedCallbacks = new BP3D.Core.Callbacks();
                /** Item */
                this.itemRemovedCallbacks = new BP3D.Core.Callbacks();
    ...
    (function (Model_1) {
        ...
        var Model = (function () {
            ...
            function Model(textureDir) {
                /** */
                this.roomLoadingCallbacks = new BP3D.Core.Callbacks();
                /** */
                this.roomLoadedCallbacks = new BP3D.Core.Callbacks();
                /** name */
                this.roomSavedCallbacks = new BP3D.Core.Callbacks();
                /** success (bool), copy (bool) */
                this.roomDeletedCallbacks = new BP3D.Core.Callbacks();
    ...
    (function (Floorplanner_1) {
        ...
        var Floorplanner = (function () {
            ...
            function Floorplanner(canvas, floorplan) {
                ...
                this.lastNode = null;
                /** */
                this.modeResetCallbacks = new BP3D.Core.Callbacks();
                /** */
                ...
                var scope = this;
                this.canvasElement.addEventListener('mousedown', function () {
                    scope.mousedown();
                });
...
(function (BP3D) {
    ...
    (function (Three) {
        ...
        (function (ControlsState) {
            ControlsState[ControlsState["NONE"] = -1] = "NONE";
            ControlsState[ControlsState["ROTATE"] = 0] = "ROTATE";
            ControlsState[ControlsState["DOLLY"] = 1] = "DOLLY";
            ControlsState[ControlsState["PAN"] = 2] = "PAN";
            ControlsState[ControlsState["TOUCH_ROTATE"] = 3] = "TOUCH_ROTATE";
            ControlsState[ControlsState["TOUCH_DOLLY"] = 4] = "TOUCH_DOLLY";
            ControlsState[ControlsState["TOUCH_PAN"] = 5] = "TOUCH_PAN";
        ...
        var Controls = (function () {
            function Controls(object, domElement) {
                ...
                // Callbacks
                this.cameraMovedCallbacks = new BP3D.Core.Callbacks();
                ...
                this.onMouseMove = function (event) {
                    if (!_this.enabled)
                        return;
                    event.preventDefault();
                    var element = _this.domElement === document
                        ? _this.domElement.body
                        : _this.domElement;
                    if (_this.state === ControlsState.ROTATE) {
                        if (_this.noRotate)
                            return;
                    ...
                    else if (_this.state === ControlsState.DOLLY) {
                        if (_this.noZoom)
                            return;
                ...
                this.onMouseUp = function () {
                    ...
                    _this.state = ControlsState.NONE;
                };
                this.onMouseWheel = function (event) {
                    if (!_this.enabled || _this.noZoom)
                        return;
                    var delta = 0;
                    if (event.wheelDelta) {
                ...
                this.onKeyDown = function (event) {
                    if (!_this.enabled || _this.noKeys || _this.noPan)
                        return;
                    switch (event.keyCode) {
                        case _this.keys.UP:
                            _this.pan(new THREE.Vector2(0, _this.keyPanSpeed));
                            break;
                        case _this.keys.BOTTOM:
                            _this.pan(new THREE.Vector2(0, -_this.keyPanSpeed));
                            break;
                        case _this.keys.LEFT:
                            _this.pan(new THREE.Vector2(_this.keyPanSpeed, 0));
                            break;
                ...
                this.onTouchStart = function (event) {
                    ...
                    switch (event.touches.length) {
                        case 1:
                            if (_this.noRotate)
                                return;
                            _this.state = ControlsState.TOUCH_ROTATE;
                            _this.rotateStart.set(event.touches[0].pageX, event.touches[0].pageY);
                            break;
                        case 2:
                            if (_this.noZoom)
                                return;
                            _this.state = ControlsState.TOUCH_DOLLY;
                        ...
                        case 3:
                            if (_this.noPan)
                                return;
                            _this.state = ControlsState.TOUCH_PAN;
                ...
                this.onTouchMove = function (event) {
                    ...
                    switch (event.touches.length) {
                        case 1:
                            if (_this.noRotate || _this.state !== ControlsState.TOUCH_ROTATE)
                                return;
                            ...
                            break;
                        case 2:
                            if (_this.noZoom || _this.state !== ControlsState.TOUCH_DOLLY)
                                return;
                            var dx = event.touches[0].pageX - event.touches[1].pageX;
                            var dy = event.touches[0].pageY - event.touches[1].pageY;
                            var distance = Math.sqrt(dx * dx + dy * dy);
                            ...
                            break;
                        case 3:
                            if (_this.noPan || _this.state !== ControlsState.TOUCH_PAN)
                                return;
            ...
            Controls.prototype.initEventListeners = function () {
                var _this = this;
                this.domElement.addEventListener('contextmenu', function (e) { return e.preventDefault(); }, false);
                this.domElement.addEventListener('mousedown', function (e) { return _this.onMouseDown(e); }, false);
                this.domElement.addEventListener('mousewheel', function (e) { return _this.onMouseWheel(e); }, false);
                this.domElement.addEventListener('DOMMouseScroll', function (e) { return _this.onMouseWheel(e); }, false);
                this.domElement.addEventListener('touchstart', function (e) { return _this.onTouchStart(e); }, false);
                this.domElement.addEventListener('touchend', function () { return _this.onTouchEnd(); }, false);
                this.domElement.addEventListener('touchmove', function (e) { return _this.onTouchMove(e); }, false);
                window.addEventListener('keydown', function (e) { return _this.onKeyDown(e); }, false);
            };
            Controls.prototype.controlsActive = function () {
                return this.state === ControlsState.NONE;
            };
            Controls.prototype.setPan = function (vec3) {
                this.panOffset = vec3;
            };
            Controls.prototype.panTo = function (vec3) {
            ...
            Controls.prototype.rotateLeft = function (angle) {
                if (angle === undefined) {
                    angle = this.getAutoRotationAngle();
                }
                this.thetaDelta -= angle;
            };
            Controls.prototype.rotateUp = function (angle) {
                if (angle === undefined) {
                    angle = this.getAutoRotationAngle();
                }
                this.phiDelta -= angle;
            ...
            Controls.prototype.pan = function (delta) {
            ...
            Controls.prototype.panXY = function (x, y) {
                this.pan(new THREE.Vector2(x, y));
            };
            Controls.prototype.dollyIn = function (dollyScale) {
                if (dollyScale === undefined) {
                    dollyScale = this.getZoomScale();
                }
                this.scale /= dollyScale;
            };
            Controls.prototype.dollyOut = function (dollyScale) {
                if (dollyScale === undefined) {
                    dollyScale = this.getZoomScale();
                }
                this.scale *= dollyScale;
            ...
            Controls.prototype.getAutoRotationAngle = function () {
                return 2 * Math.PI / 60 / 60 * this.autoRotateSpeed;
            };
            Controls.prototype.getZoomScale = function () {
                return Math.pow(0.95, this.zoomSpeed);
            };
            // Private internals
            Controls.EPS = 0.000001;
            return Controls;
        })();
...
(function (BP3D) {
    ...
    (function (Three) {
        ...
        (function (ControllerState) {
            ControllerState[ControllerState["UNSELECTED"] = 0] = "UNSELECTED";
            ControllerState[ControllerState["SELECTED"] = 1] = "SELECTED";
            ControllerState[ControllerState["DRAGGING"] = 2] = "DRAGGING";
            ControllerState[ControllerState["ROTATING"] = 3] = "ROTATING";
            ControllerState[ControllerState["ROTATING_FREE"] = 4] = "ROTATING_FREE";
            ControllerState[ControllerState["PANNING"] = 5] = "PANNING";
        ...
        var Controller = (function () {
            function Controller(three, model, camera, element, controls, hud) {
                ...
                this.state = ControllerState.UNSELECTED;
                this.three = three;
                this.model = model;
            ...
            Controller.prototype.init = function () {
                var _this = this;
                if (this.element) {
                    this.element.addEventListener('mousedown', function (e) { return _this.mouseDownEvent(e); });
                    this.element.addEventListener('mouseup', function (e) { return _this.mouseUpEvent(e); });
                    this.element.addEventListener('mousemove', function (e) { return _this.mouseMoveEvent(e); });
                }
                this.scene.itemRemovedCallbacks.add(function (item) { return _this.itemRemoved(item); });
                this.scene.itemLoadedCallbacks.add(function (item) { return _this.itemLoaded(item); });
            };
            Controller.prototype.createGroundPlane = function () {
                var size = 10000;
            ...
            Controller.prototype.itemLoaded = function (item) {
            ...
            Controller.prototype.clickPressed = function (vec2) {
            ...
            Controller.prototype.clickDragged = function (vec2) {
                vec2 = vec2 || this.mouse;
                var intersection = this.itemIntersection(this.mouse, this.selectedObject);
                if (intersection) {
                    if (this.isRotating()) {
            ...
            Controller.prototype.itemRemoved = function (item) {
            ...
            Controller.prototype.checkWallsAndFloors = function () {
            ...
            Controller.prototype.mouseMoveEvent = function (event) {
                if (!this.enabled)
                    return;
                event.preventDefault();
                this.mouseMoved = true;
            ...
            Controller.prototype.isRotating = function () {
                return this.state === ControllerState.ROTATING || this.state === ControllerState.ROTATING_FREE;
            };
            Controller.prototype.mouseDownEvent = function (event) {
                if (!this.enabled)
                    return;
                event.preventDefault();
                this.mouseMoved = false;
            ...
            Controller.prototype.mouseUpEvent = function (event) {
                if (!this.enabled)
                    return;
                this.mouseDown = false;
                switch (this.state) {
            ...
            Controller.prototype.switchState = function (newState) {
            ...
            Controller.prototype.onEntry = function (state) {
                switch (state) {
                    case ControllerState.UNSELECTED:
                        this.setSelectedObject(null);
                    // Fall through
            ...
            Controller.prototype.onExit = function (state) {
                switch (state) {
                    case ControllerState.UNSELECTED:
                    case ControllerState.SELECTED:
                        break;
            ...
            Controller.prototype.getSelectedObject = function () {
                return this.selectedObject;
            };
            Controller.prototype.updateIntersections = function () {
            ...
            Controller.prototype.normalizeVector2 = function (vec2) {
            ...
            Controller.prototype.mouseToVec3 = function (vec2) {
                var normVec2 = this.normalizeVector2(vec2);
                var vector = new THREE.Vector3(normVec2.x, normVec2.y, 0.5);
                vector.unproject(this.camera);
                return vector;
            };
            Controller.prototype.itemIntersection = function (vec2, item) {
            ...
            Controller.prototype.getIntersections = function (vec2, objects, filterByNormals, onlyVisible, recursive, linePrecision) {
                // Set defaults for optional parameters
                if (filterByNormals === undefined)
                    filterByNormals = false;
            ...
            Controller.prototype.setSelectedObject = function (object) {
            ...
            Controller.prototype.updateMouseover = function () {
                if (this.intersectedObject !== null) {
            ...
            Controller.prototype.rotatePressed = function () {
                // Placeholder for rotation pressed logic
            };
            Controller.prototype.rotateReleased = function () {
    ...
    (function (Three) {
        var Main = (function () {
            function Main(model, element, canvasElement, opts) {
                ...
                this.elementWidth = 0;
                // Callbacks
                this.itemSelectedCallbacks = new BP3D.Core.Callbacks();
                this.itemUnselectedCallbacks = new BP3D.Core.Callbacks();
                this.wallClicked = new BP3D.Core.Callbacks();
                this.floorClicked = new BP3D.Core.Callbacks();
                this.nothingClicked = new BP3D.Core.Callbacks();
                ...
                this.updateWindowSize = function () {
                    ...
                    _this.heightMargin = rect.top + window.scrollY;
                    _this.widthMargin = rect.left + window.scrollX;
                    _this.elementWidth = _this.element.clientWidth;
                    if (_this.options.resize) {
                        _this.elementHeight = window.innerHeight - _this.heightMargin;
                    }
                    else {
                        _this.elementHeight = _this.element.clientHeight;
                    }
                    console.log("Main.updateWindowSize: ", {
                        rect: rect,
                        scrollY: window.scrollY,
                        innerHeight: window.innerHeight,
                        heightMargin: _this.heightMargin,
                        elementWidth: _this.elementWidth,
                        elementHeight: _this.elementHeight
                    });
                    if (_this.elementWidth < 0)
                        _this.elementWidth = 0;
                    if (_this.elementHeight < 0)
                        _this.elementHeight = 0;
                    _this.camera.aspect = _this.elementWidth / _this.elementHeight;
                    _this.camera.updateProjectionMatrix();
                    _this.renderer.setSize(_this.elementWidth, _this.elementHeight);
                    _this._needsUpdate = true;
                };
                this.centerCamera = function () {
                    var yOffset = 150.0;
                    var pan = _this.model.floorplan.getCenter();
                    pan.y = yOffset;
                    _this.controls.target = pan;
                    var distance = _this.model.floorplan.getSize().z * 1.5;
            ...
            Main.prototype.init = function () {
                ...
                this.controller = new Three.Controller(this, this.model, this.camera, this.element, this.controls, this.hud);
                if (this.domElement) {
                ...
                // Setup camera nicely
                this.centerCamera();
                this.model.floorplan.fireOnUpdatedRooms(function () { return _this.centerCamera(); });
                var lights = new Three.Lights(this.scene, this.model.floorplan);
                this.floorplan = new Three.Floorplan(this.scene, this.model.floorplan, this.controls);
                this.animate();
            ...
            Main.prototype.dataUrl = function () {
                return this.renderer.domElement.toDataURL("image/png");
            };
            Main.prototype.stopSpin = function () {
            ...
            Main.prototype.getScene = function () {
                return this.scene;
            };
            Main.prototype.getController = function () {
                return this.controller;
            };
            Main.prototype.getCamera = function () {
                return this.camera;
            };
            Main.prototype.needsUpdate = function () {
                this._needsUpdate = true;
            };
            Main.prototype.shouldRender = function () {
            ...
            Main.prototype.rotatePressed = function () {
                this.controller.rotatePressed();
            };
            Main.prototype.rotateReleased = function () {
                this.controller.rotateReleased();
            };
            Main.prototype.setCursorStyle = function (cursorStyle) {
                if (this.domElement) {
                    this.domElement.style.cursor = cursorStyle;
                }
            };
            Main.prototype.projectVector = function (vec3, ignoreMargin) {
                if (ignoreMargin === undefined)
                    ignoreMargin = false;
